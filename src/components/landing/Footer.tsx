        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Supercharge your development productivity with our all-in-one project management and collaboration platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Meeting Scheduler</a></li>
